...
gs = {
	...
	buildgrid: function (area, j, showgrid) {
		...
		var set = JSON.parse('{"id":"19062","name":"Ryan Rushing - wide","widths":{"1000":{"width":1000,"grids":{"l":{"name":"Large","prefix":"l","width":1000,"columns":{"l1":{"name":"l1","unit":"%","percent":10,"px":100},"l2":{"name":"l2","unit":"%","percent":10,"px":100},"l3":{"name":"l3","unit":"%","percent":22.425,"px":224.25},"l4":{"name":"l4","unit":"%","percent":22.425,"px":224.25},"l5":{"name":"l5","unit":"%","percent":10,"px":100},"l6":{"name":"l6","unit":"%","percent":10,"px":100}},"gutter":{"unit":"px","px":30,"percent":3},"ratio":{"name":"bipenton","value":0.46}}}},"600":{"width":600,"grids":{"m":{"name":"Medium","prefix":"m","width":600,"columns":{"m1":{"name":"m1","unit":"%","percent":10,"px":60},"m2":{"name":"m2","unit":"%","percent":10,"px":60},"m3":{"name":"m3","unit":"%","percent":46.25,"px":277.5},"m4":{"name":"m4","unit":"%","percent":10,"px":60},"m5":{"name":"m5","unit":"%","percent":10,"px":60}},"gutter":{"unit":"px","px":20,"percent":3.33333333},"ratio":{"name":"bipenton","value":0.46}}}},"400":{"width":400,"grids":{"s":{"name":"Small","prefix":"s","width":400,"columns":{"s1":{"name":"s1","unit":"%","percent":10,"px":40},"s2":{"name":"s2","unit":"%","percent":36.125,"px":144.5},"s3":{"name":"s3","unit":"%","percent":36.125,"px":144.5},"s4":{"name":"s4","unit":"%","percent":10,"px":40}},"gutter":{"unit":"px","px":10,"percent":2.5},"ratio":{"name":"thirds","value":0.33333333}}}}},"prefixes":{"index":["l","m","s"],"1000":["l"],"600":["m"],"400":["s"]}}'),
	...
	getstyle : function (t, p){
	 ...
	 if (t.currentStyle) return el.currentStyle[p];
